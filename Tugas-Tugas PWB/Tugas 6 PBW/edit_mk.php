            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card border-0 my-5">
                        ...
                        <div class="card-body">
                            <form action="edit_proccess_mk.php" method="post" enctype="multipart/form-data" class="row g-4">
                                <div>
                                    <label for="kodemk" class="form-label">Kode Mata Kuliah</label>
                                    <input type="text" name="kodemk" id="kodemk" class="form-control" value="<?= $data['kodemk'] ?>" disabled>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="jumlah_sks" id="jumlah_sks" class="form-control" value="<?= $data['jumlah_sks'] ?>">
                                </div>
                                <div>
